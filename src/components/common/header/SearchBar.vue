  ...
  <form class="min-w-80">
    ...
    <div class="relative">
      ...
      <input type="search" id="default-search"
             ...
             placeholder="Город, номер стрима..." required />
      <button type="submit"
              class="text-white absolute end-1 bottom-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3.5 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Поиск
      </button>
    </div>
  </form>
